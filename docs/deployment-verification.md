...
2026-09-09 기준 `main-By2nz__J.js` 후보의 최종 로컬 집중 검사는 통과했지만, 커밋 `bb2590f9e8abfec0ee2a9324e82e890f084bb688`의 main CI 전체 Go 검사에서 문서 조회 예산 시험 1건이 실패했습니다. 후보 권한 조회를 최적화한 뒤 PG17·18 집중 회귀는 통과했으며, 수정 후 전체 CI와 새 이미지·태그·공개 릴리즈는 아직 미완료입니다.
...
| 수정 후 전체 Go·독립 브라우저 검사 | [main CI 34350211768](https://github.com/hkjang/madi/actions/runs/34350211768) 전체 Go 2,363.270초 실행에서 문서 조회 예산 시험 1건 실패. 35개 브라우저 옵션에서 실패가 없었더라도 전체 Go 통과는 아님. 실제 조회 경로 보완·재검증 대기 |
